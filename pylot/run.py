...
"""
  ...
  -g, --gui                   :  start GUI
  -j, --jsonrpc               :  start GUI by jsonrpc
...
elif jsonrpc:  # gui mode
    from ui.gui import Application
    from core.rpcserver import *
    #pylot_gui.main(agents, rampup, interval, duration, tc_xml_filename, log_msgs, VERSION, output_dir, test_name)
    import wx
    from wx.lib.mixins.listctrl import ListCtrlAutoWidthMixin
    #app = wx.App(0)
    ap = Application(None, agents, rampup, interval, duration, tc_xml_filename, log_msgs, VERSION, output_dir=None, test_name=None)
    def service():
        ap.on_run(None)
